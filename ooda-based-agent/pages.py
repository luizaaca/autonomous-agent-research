PAGES = {
    ...
    3: {
        ...
        "choices": [
            {"text": "Perguntar diretamente sobre o hematoma", "goto": 14},
            {"text": "Esperar que ela retorne para a porta", "goto": 20},
            {"text": "Aproveitar a oportunidade para olhar dentro da casa", "goto": 31},
            {"text": "Perguntar sobre 'aqueles dois rapazes'", "goto": 35},
            {"text": "Insistir para entrar e conversar", "goto": 46},
        ],
    },
    4: {
    ...
    7: {
        ...
        "choices": [
            {"text": "Bater firmemente na porta", "goto": 13},
            {"text": "Deslizar para os fundos", "goto": 33},
            {
                "text": "Atrair a Sra. Fellaman para fora batendo na janela e se escondendo",
                "goto": 70,
            },
        ],
    },
    8: {
        ...
        "choices": [
            {"text": "Se decidiu desarmar seu oponente", "goto": 23},
            {"text": "Se decidiu fugir da luta", "goto": 109},
        ],
    },
    9: {
    ...
    11: {
        ...
        "choices": [
            {
                "text": "Aproximar-se sorrateiramente das lixeiras para olhar",
                "goto": 15,
            },
            {"text": "Continuar a vigilância à distância", "goto": 24},
        ],
    },
    12: {
        "text": "You try to step back from the swing, but the heavy hammer smashes into your shoulder and knocks you off-balance. You roll the dice for DEX. Mark down that you take 2 damage. If you have suffered 2 damage in total, you are Bloodied, and so mark the Hurt and Bloodied boxes on your character sheet and go to 34. If you have suffered a total of 3 or more damage, you are Down, and so mark the Down box on your character sheet and go to 78.",
        "choices": [
            {
                "roll": "DEX",
                "results": {
    ...
    14: {
        ...
        "choices": [
            {
                "text": "Esperar pacientemente que a Sra. Fellaman o convide para entrar",
                "goto": 61,
            },
            {
                "text": "Procurar por algo que possa facilitar uma entrada ilícita",
                "goto": 71,
            },
            {"text": "Perguntar sobre os 'dois rapazes'", "goto": 76},
            {"text": "Insistir em olhar dentro da casa", "goto": 82},
        ],
    },
    15: {
    ...
    17: {
        ...
        "choices": [
            {"luck_roll": True, "results": {"3": {"goto": 25}, "2": {"goto": 36}}}
        ],
    },
    18: {
    ...
    20: {
        ...
        "choices": [
            {
                "text": "Perguntar sobre o hematoma na bochecha da Sra. Fellaman",
                "goto": 50,
            },
            {
                "text": "Procurar por algo que possa facilitar uma entrada ilícita",
    ...
    27: {
        ...
        "choices": [
            {"text": "Se ainda não tentou, ir pelos fundos", "goto": 33},
            {"text": "Tentar atraí-la para fora batendo na janela", "goto": 70},
            {"text": "Caso contrário, realizar uma entrada forçada", "goto": 104},
        ],
    },
    28: {
        ...
        "choices": [
            {"text": "Gastar Sorte para vencer a disputa", "goto": 8},
            {
                "text": "Não gastar Sorte (Knuckles poderá ganhar a disputa).",
                "goto": 12,
            },
        ],
    },
    ...
    31: {
        ...
        "choices": [
            {"text": "Perguntar sobre o hematoma", "goto": 50},
            {"text": "Esperar pacientemente que ela o convide para entrar", "goto": 61},
            {"text": "Perguntar sobre os 'dois rapazes'", "goto": 76},
            {"text": "Insistir em olhar dentro da casa", "goto": 82},
        ],
    },
    ...
    46: {
        ...
        "choices": [
            {"text": "Perguntar sobre o hematoma", "goto": 50},
            {"text": "Esperar pacientemente", "goto": 61},
            {"text": "Procurar entrada ilícita", "goto": 71},
            {"text": "Perguntar sobre os 'dois rapazes'", "goto": 76},
        ],
    },
    47: {
    ...
    48: {
        ...
        "choices": [
            {"text": "Se o dano total for 1 ou 2", "goto": 67},
            {"text": "Se o dano total for 3", "goto": 95},
        ],
    },
    49: {
        ...
        "choices": [
            {"text": "Se ainda não tentou, voltar e bater na porta", "goto": 13},
            {"text": "Caso contrário, realizar uma entrada forçada", "goto": 104},
        ],
    },
    50: {
    ...
    51: {
        ...
        "choices": [
            {"text": "Perguntar ao fantasma sobre a Sra. Fellaman", "goto": 63},
            {"text": "Perguntar ao fantasma por que ele está aqui", "goto": 93},
            {"text": "Desligar o werelight", "goto": 101},
        ],
    },
    52: {
        ...
        "choices": [
            {"luck_roll": True, "results": {"3": {"goto": 57}, "2": {"goto": 66}}}
        ],
    },
    53: {
    ...
    54: {
        ...
        "choices": [
            {"text": "Se o dano total for 3 ou mais", "goto": 99},
            {"text": "Caso contrário", "goto": 67},
        ],
    },
    55: {
        ...
        "choices": [
            {
                "goto": 65,
                "effects": [
                    {"action": "apply_penalty", "skill": "Fighting", "duration": 1}
                ],
            }
        ],
    },
        ...
        "choices": [
            {
                ...
                "roll": "Magic",
                "bonus_dice": True,
                "results": {"3": {"goto": 86}, "2": {"goto": 97}, "1": {"goto": 97}},
            },
            {
                ...
                "roll": "Magic",
                "bonus_dice": True,
                "results": {"3": {"goto": 80}, "2": {"goto": 97}, "1": {"goto": 97}},
            },
        ],
    },
    70: {
    ...
    75: {
        ...
        "choices": [
            {"text": "Se você aumentou o feitiço", "goto": 80},
            {"text": "Caso contrário", "goto": 86},
        ],
    },
    76: {
    ...
    77: {
        ...
        "choices": [
            {
                "text": "Tentar a Sorte (Try Your Luck) para usar Animal Handling",
                "goto": 85,
            },
            {"text": "Não gastar Sorte", "goto": 98},
        ],
    },
    78: {
    ...
    81: {
        ...
        "choices": [
            {"luck_roll": True, "results": {"3": {"goto": 90}, "2": {"goto": 94}}}
        ],
    },
    82: {
        ...
        "choices": [
            {
                ...
                "roll": "INT",
                "difficulty": "hard",
                "results": {"5": 92, "4": 92, "3": 92, "2": 98, "1": 98},
            },
            {
    ...
    89: {
        ...
        "choices": [
            {"text": "Se dano total 1 (Hurt) ou 2 (Bloodied)", "goto": 16},
            {"text": "Se dano total 3 (Down)", "goto": 95},
        ],
    },
    90: {
    ...
    91: {
        ...
        "choices": [
            {"text": "Se ainda não tentou, recuar e ir pelos fundos", "goto": 33},
            {"text": "Caso contrário, realizar entrada forçada", "goto": 104},
        ],
    },
    92: {
        ...
        "choices": [
            {
                "goto": 106,
                "effects": [
                    {"action": "spend_luck", "amount": 10},
                    {"action": "gain_skill", "skill": "Animal Handling"},
                ],
            }
        ],
    },
        ...
        "choices": [
            {
                ...
                "goto": 73,
                "effects": [
                    {"action": "take_damage", "amount": 1, "condition": "full_health"}
                ],
            },
    ...
    999: {
        "text": "Suas forças se esvaem. Você cai no chão, incapaz de continuar. A escuridão toma conta de sua visão. Sua jornada termina aqui.",
        "choices": [],
    },
}
